...
module.exports = class RpgCharacter {
    ...
    constructor(name, type, stats, spells) {
        ...
        this.BUFFS_AVAILABLE = this.SPECS_NEEDED.slice(0)
        this.BUFFS_AVAILABLE.push('defense', 'attack')
     ...
     */
    get attack() {
        return this.strength * 10 + this.getBuff('attack')
    }
    /**
     * Défense calculée
     ...
     */
    get defense() {
        return this.strength * 5 + this.constitution * 5 + this.getBuff('defense')
    }
    /**
    ...
    addBuff(stat, value, duration) {
        ...
        if (!this.BUFFS_AVAILABLE.includes(stat)) {
